				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse"
						...
						<ul class="nav navbar-nav">
							...
							<li class="active"><a
								href="/KnowledgeManagementSystem/jsp/download.jsp">Download</a></li>
			...
			<div id="includedContent">
				...
				<fieldset>
					...
					<table class="table table-striped">
						<thead>
							<tr>
								<th colspan="6"><center>All Files to Download</center></th>
							</tr>
						...
						<tbody id="tbodyContent">
							<%
								DocumentService documentService = new DocumentService();
									List<Post> list = documentService.getListOfPosts();
									for (Post u : list) {
							%>
							<tr>
